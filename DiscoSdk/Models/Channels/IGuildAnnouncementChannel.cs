...
/// <summary>
/// Represents a Discord guild announcement channel.
/// </summary>
public interface IGuildAnnouncementChannel : IGuildChannel, ITextBasedChannel
{
    /// <summary>
    /// Creates a builder for editing this channel.
    /// </summary>
    /// <returns>An <see cref="IEditTextBasedChannelRestAction{IGuildAnnouncementChannel}"/> instance for editing the channel.</returns>
    IEditGuildAnnouncementChannelRestAction Edit();
