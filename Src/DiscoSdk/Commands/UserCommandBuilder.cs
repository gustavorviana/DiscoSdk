...
/// <summary>
/// Fluent builder for user context menu commands (<see cref="ApplicationCommandType.User"/>).
/// </summary>
public class UserCommandBuilder()
{
    ...
    /// <returns>The current <see cref="UserCommandBuilder"/> instance.</returns>
    ...
    /// </param>
    /// <returns>The current <see cref="UserCommandBuilder"/> instance.</returns>
    public UserCommandBuilder WithNameLocalizations(Dictionary<string, string> localizations)
    {
    ...
    /// </param>
    /// <returns>The current <see cref="UserCommandBuilder"/> instance.</returns>
    public UserCommandBuilder WithDefaultMemberPermissions(string permissions)
    {
    ...
    /// </param>
    /// <returns>The current <see cref="UserCommandBuilder"/> instance.</returns>
    public UserCommandBuilder WithDmPermission(bool dmPermission)
    {
    ...
    /// <returns>The current <see cref="UserCommandBuilder"/> instance.</returns>
    public UserCommandBuilder WithNsfw(bool nsfw)
    {
        _nsfw = nsfw;
        return this;
    }
    ...
    /// <summary>
    /// Builds the configured <see cref="SlashCommand"/> with <see cref="ApplicationCommandType.User"/>.
    /// </summary>
