...
internal class ReactionWrapper : IReaction
{
    ...
    /// <summary>
    /// Removes this reaction from the message (current user's reaction).
    /// </summary>
    ...
    public Task DeleteAsync(CancellationToken cancellationToken = default)
    {
        ...
        if (Me)
            return _client.MessageClient.RemoveReactionAsync(_message.ChannelId, _message.Id, Emoji.ToString()!, cancellationToken);

        return _client.MessageClient.RemoveUserReactionAsync(_message.ChannelId, _message.Id, Emoji.ToString()!, _message.Author.Id, cancellationToken);
    }
