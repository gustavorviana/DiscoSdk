...
{
	public VoiceChannelManagerWrapper(DiscordId channelId, ChannelClient channelClient)
    ...
    IVoiceChannelManager IChannelManager<IVoiceChannelManager>.SetParent(DiscordId? parentId)
        => SetParent(parentId);
