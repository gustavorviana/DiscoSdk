...
{
	public ThreadChannelManagerWrapper(DiscordId channelId, ChannelClient channelClient)
    ...
    IThreadChannelManager IChannelManager<IThreadChannelManager>.SetParent(DiscordId? parentId)
		=> SetParent(parentId);
